...
#define SAF_VERSION_STRING "1.011d"
...
void SAF_FE_GF_init(uint8_t CLIParameters[128])
{
    ...
    if (CLIParameters['u'] != 0)
    {
        ...
        _SDL_upscaleScreen = (uint8_t*)malloc(SAF_SCREEN_WIDTH * SAF_SCREEN_WIDTH * 4);
    }
...
{
  127,126,126,126,126,126,125,125,124,123,123,122,121,120,119,118,117,115,114,
  113,111,109,108,106,104,103,101,99,97,95,93,90,88,86,84,81,79,76,74,71,68,66,
  63,60,57,55,52,49,46,43,40,37,34,31,28,25,22,18,15,12,9,6,3,0
};
